...
from charm import SERVICE_NAME, SentrySnubaK8SCharm
...
def test_pebble_ready(monkeypatch: pytest.MonkeyPatch):
    ...
    # Arrange:
    ctx = testing.Context(SentrySnubaK8SCharm)
    ...
    monkeypatch.setattr("charm.sentry_snuba.get_version", mock_get_version)
