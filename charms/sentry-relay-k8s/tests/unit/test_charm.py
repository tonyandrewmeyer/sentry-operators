...
from charm import SERVICE_NAME, SentryRelayK8SCharm
...
def test_pebble_ready(monkeypatch: pytest.MonkeyPatch):
    ...
    # Arrange:
    ctx = testing.Context(SentryRelayK8SCharm)
    ...
    monkeypatch.setattr("charm.sentry_relay.get_version", mock_get_version)
